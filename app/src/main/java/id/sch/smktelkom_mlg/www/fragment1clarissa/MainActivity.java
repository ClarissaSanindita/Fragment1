package id.sch.smktelkom_mlg.www.fragment1clarissa;
...
import static id.sch.smktelkom_mlg.www.fragment1clarissa.R.id.listDialogBtn;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tampilList = (Button) findViewById(listDialogBtn);
